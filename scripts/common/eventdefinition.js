...
(function () {
	...
	$.DefineEvent(
		...
		"itemId",
		"typeParams",
		"Requesting an item preview popup for the given item id. typeParams, caseid, key id"
	);
	...
	$.DefineEvent(
		"EndOfMatch_GetFreeForAllTopThreePlayers_Response",
		3,
		"first, second, third",
		"Callback for Scoreboard_GetFreeForAllTopThreePlayers"
	);
	$.DefineEvent(
		"Scoreboard_GetFreeForAllPlayerPosition",
		1,
		"xuid",
		"Given a player index and an xuid, returns top three players on that player's team"
	);
	$.DefineEvent(
		"EndOfMatch_GetFreeForAllPlayerPosition_Response",
		1,
		"position",
	...
	$.DefineEvent(
		"NavigateToTab",
		4,
		"tab name, xml name, If its a tab, if you should add to stack",
