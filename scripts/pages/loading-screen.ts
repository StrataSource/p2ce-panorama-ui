...
class LoadingScreenController {
	...
	static portal2_Campaign_A3Part2Maps = [
		"sp_a3_speed_ramp",
		"sp_a3_speed_flings"
	];
	
	static portal2_Campaign_A3OutroMaps = [
		"sp_a3_portal_intro",
		"sp_a3_end"
	];
	...
	static portal2_Campaign_A5Maps = [
		"sp_a5_credits"
	];
	...
	static portal2_SXCampaign_A2Maps = [
		"sp_a2_sx_intro",
		"sp_a2_sx_reaching"
	];
	
	static portal2_SXCampaign_A3Maps = [
		"sp_a3_sx_intro",
		"sp_a3_sx_shield"
	];
	
	static portal2_SXCampaign_A4Maps = [
		"sp_a4_sx_intro",
		"sp_a4_sx_thru_portals"
	];
	
	static portal2_SXCampaign_A5Maps = [
		"sp_a5_sx_final"
	];
	
	static portal2_SXCampaign_A6Maps = [
		"sp_a6_sx_intro",
		"sp_a6_sx_lasers"
	];
	
	static portal2_SXCampaign_A7Maps = [
		"sp_a7_sx_gel",
		"sp_a7_sx_paint"
	];
	...
	static updateLoadingScreenInfo(mapName: string) {
		function getMapImage(map: string, number: Number) {			
			...
			if (map.startsWith('e1912'))
				return base + 'e1912_1_widescreen.vtf';
			
			// Standard Portal 2 SP maps.
			else if (map.startsWith('sp_a1'))
				return base + 'a1_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a2'))
				return base + 'a2_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a3'))
				return base + 'a3_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a4'))
				return base + 'a4_' + number + '_widescreen.vtf';
			...
			else if (map.startsWith('sp_a1_sx'))
				return sx_base + 'a1_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a2_sx'))
				return sx_base + 'a2_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a3_sx'))
				return sx_base + 'a3_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a4_sx'))
				return sx_base + 'a4_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a5_sx'))
				return sx_base + 'a5_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a6_sx'))
				return sx_base + 'a6_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a7_sx'))
				return sx_base + 'a7_' + number + '_widescreen.vtf';
			else if (map.startsWith('sp_a8_sx'))
				return sx_base + 'a8_' + number + '_widescreen.vtf';
			...
			else if (LoadingScreenController.portal2_Campaign_A1Maps.includes(LoadingScreenController.lastLoadedMapName))
				return base + 'default_a_' + number + '_widescreen.vtf';
			else if (LoadingScreenController.portal2_Campaign_A2Maps.includes(LoadingScreenController.lastLoadedMapName))
				return base + 'default_b_' + number + '_widescreen.vtf';
			else if (LoadingScreenController.portal2_Campaign_A3Part1Maps.includes(LoadingScreenController.lastLoadedMapName))
				return base + 'default_c_' + number + '_widescreen.vtf';
			else if (LoadingScreenController.portal2_Campaign_A3Part2Maps.includes(LoadingScreenController.lastLoadedMapName))
				return base + 'default_d_' + number + '_widescreen.vtf';
			else if (LoadingScreenController.portal2_Campaign_A3OutroMaps.includes(LoadingScreenController.lastLoadedMapName))
				return base + 'default_b_' + number + '_widescreen.vtf';
			else if (LoadingScreenController.portal2_Campaign_A4Maps.includes(LoadingScreenController.lastLoadedMapName))
				return base + 'default_e_' + number + '_widescreen.vtf';
			else if (LoadingScreenController.portal2_Campaign_A5Maps.includes(LoadingScreenController.lastLoadedMapName))
		...
		if (mapName.startsWith('mp')) {	
			imageNumber1, imageNumber2 = Math.floor(Math.random() * 3) + 1;
		} else {
			imageNumber1 = 1;
			imageNumber2 = 4;
		}
